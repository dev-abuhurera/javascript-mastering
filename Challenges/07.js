...
const bmiMark = mark.calBMI();
const bmiJohn = john.calBMI();

console.log(bmiMark + " " + bmiJohn);

console.log(bmiMark > bmiJohn ? `The bmi of mark ${bmiMark}  >  john's bmi: ${bmiJohn}` : `The bmi of mark ${bmiMark}  <  john's bmi: ${bmiJohn}`);
